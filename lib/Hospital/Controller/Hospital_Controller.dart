...
class hospitalController{
  ...
  // register hospital
  Future<String?> registerHospital(String hospitalname, String email, String password, String? imageUrl, String state, String district, String description, String phone) async {
    try {
